...
public class InitializerRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repository.save(User.builder().username("koray").password("1234").role(Role.ADMIN).build());
        repository.save(User.builder().username("ali").password("1234").role(Role.USER).build());
